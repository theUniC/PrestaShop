...
use Prestashop\Webservice\WebserviceOutputXML;
use Prestashop\Context;
use Prestashop\Configuration;
use Prestashop\Product;
use Prestashop\Tools;
use Prestashop\Webservice\WebserviceOutputBuilder;
use Prestashop\Language;
use Prestashop\Webservice\WebserviceException;
...
';
                    ...
                    $sql_sort .= 'main_i18n.`' . pSQL($this->resourceConfiguration['fields'][$fieldName]['sqlId']) . '` ' . $direction . ', ';
                } else {
                    ...
                    $sql_sort .= (isset($this->resourceConfiguration['retrieveData']['tableAlias']) ? '`' . bqSQL($this->resourceConfiguration['retrieveData']['tableAlias']) . '`.' : '`' . bqSQL($table_alias) . '`.') . '`' . pSQL($this->resourceConfiguration['fields'][$fieldName]['sqlId']) . '` ' . $direction . ', ';
                }
            }
