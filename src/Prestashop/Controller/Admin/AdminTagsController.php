...
class AdminTagsController extends AdminController
{
    public function __construct()
    {
        $this->table = 'tag';
        $this->className = 'Tag';
        $this->fields_list = array('id_tag' => array('title' => $this->l('ID'), 'align' => 'center', 'width' => 25), 'lang' => array('title' => $this->l('Language'), 'filter_key' => 'l!name'), 'name' => array('title' => $this->l('Name'), 'width' => 200, 'filter_key' => 'a!name'), 'products' => array('title' => $this->l('Products:'), 'align' => 'right', 'havingFilter' => true));
