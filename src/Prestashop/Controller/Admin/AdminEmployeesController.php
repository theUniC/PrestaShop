...
class AdminEmployeesController extends AdminController
{
    ...
    public function renderForm()
    {
        ...
        if ((int) $this->tabAccess['edit'] && !$this->restrict_edition) {
            ...
            $this->fields_form['input'][] = array('type' => 'select', 'label' => $this->l('Profile Permission:'), 'name' => 'id_profile', 'required' => true, 'options' => array('query' => $available_profiles, 'id' => 'id_profile', 'name' => 'name', 'default' => array('value' => '', 'label' => $this->l('-- Choose --'))));
