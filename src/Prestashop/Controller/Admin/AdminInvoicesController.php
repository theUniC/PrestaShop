...
class AdminInvoicesController extends AdminController
{
    ...
    {
        $this->toolbar_btn['save-date'] = array('href' => '#', 'desc' => $this->l('Generate PDF file by date'));
        $this->toolbar_btn['save-status'] = array('href' => '#', 'desc' => $this->l('Generate PDF file by status.'));
    }
