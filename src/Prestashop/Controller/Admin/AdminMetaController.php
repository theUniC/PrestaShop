...
class AdminMetaController extends AdminController
{
    ...
    public function addFieldRoute($route_id, $title)
    {
        ...
        $this->fields_options['routes']['fields']['PS_ROUTE_' . $route_id] = array('title' => $title, 'desc' => sprintf($this->l('Keywords: %s'), implode(', ', $keywords)), 'validation' => 'isString', 'type' => 'text', 'size' => 70, 'defaultValue' => Dispatcher::getInstance()->default_routes[$route_id]['rule']);
    }
...
');
    ...
    public function getRobotsContent()
    {
        ...
        $tab['GB'] = array('orderby=', 'orderway=', 'tag=', 'id_currency=', 'search_query=', 'back=', 'n=');
