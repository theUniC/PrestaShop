...
class AdminManufacturersController extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->fields_list = array('id_manufacturer' => array('title' => $this->l('ID'), 'width' => 25), 'logo' => array('title' => $this->l('Logo'), 'image' => 'm', 'orderby' => false, 'search' => false, 'width' => 150, 'align' => 'center'), 'name' => array('title' => $this->l('Name'), 'width' => 'auto'), 'addresses' => array('title' => $this->l('Addresses'), 'width' => 20, 'align' => 'center', 'havingFilter' => true), 'products' => array('title' => $this->l('Products:'), 'havingFilter' => true, 'width' => 20, 'align' => 'center'), 'active' => array('title' => $this->l('Enabled'), 'width' => 70, 'active' => 'status', 'type' => 'bool', 'align' => 'center', 'orderby' => false));
        parent::__construct();
    }
    ...
    public function renderForm()
    {
        ...
        $this->fields_value = array('image' => $image ? $image : false, 'size' => $image ? filesize(_PS_MANU_IMG_DIR_ . '/' . $manufacturer->id . '.jpg') / 1000 : false);
    ...
    public function renderFormAddress()
    {
        ...
        $form['input'][] = array('type' => 'text', 'label' => $this->l('Zip Code/Postal Code'), 'name' => 'postcode', 'required' => true, 'size' => 33, 'required' => false);
