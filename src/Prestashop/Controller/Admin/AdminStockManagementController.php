            ...
            if (count($this->errors) == 0) {
                ...
                if (count($removed_products) > 0) {
                    ...
                    if ($usable_quantity_in_stock < $quantity) {
                        ...
                        if ($not_usable_quantity < $quantity) {
