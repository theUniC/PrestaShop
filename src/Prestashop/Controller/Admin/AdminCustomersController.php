...
class AdminCustomersController extends AdminController
{
    ...
    public function renderForm()
    {
        ...
        if (Configuration::get('PS_B2B_ENABLE')) {
            ...
            $this->fields_form['input'][] = array('type' => 'text', 'label' => $this->l('Maximum number of payment days:'), 'name' => 'max_payment_days', 'size' => 10, 'hint' => $this->l('Valid characters:') . ' 0-9');
    ...
    public function processGuestToCustomer()
    {
        ...
        if (Customer::customerExists($customer->email)) {
            ...
            if ($customer->transformToCustomer(Tools::getValue('id_lang', $this->context->language->id))) {
