...
use Prestashop\Referrer;
use Prestashop\Db\Db;
use Prestashop\Tab;
use Prestashop\Shop\Shop;
use Prestashop\Context;
use Prestashop\Configuration;
use Prestashop\Controller\Admin\AdminStatsController;
use Prestashop\Module\ModuleGraph;
/*
...
class AdminReferrersController extends AdminController
{
    ...
    public function renderForm()
    {
        ...
        $this->fields_form[0] = array('form' => array('legend' => array('title' => $this->l('Affiliate'), 'image' => '../img/admin/affiliation.png'), 'input' => array(array('type' => 'text', 'label' => $this->l('Name:'), 'name' => 'name', 'size' => 20, 'required' => true), array('type' => 'password', 'label' => $this->l('Password:'), 'name' => 'passwd', 'size' => 20, 'desc' => $this->l('Leave blank if no change'))), 'desc' => array($this->l('Affiliates can access their data with this name and password.'), $this->l('Front access:') . ' <a href="' . $uri . 'modules/trackingfront/stats.php" style="font-style: italic;">' . $uri . 'modules/trackingfront/stats.php</a>')));
        $this->fields_form[1] = array('form' => array('legend' => array('title' => $this->l('Commission plan'), 'image' => '../img/admin/money.png'), 'input' => array(array('type' => 'text', 'label' => $this->l('Click fee:'), 'name' => 'click_fee', 'size' => 8, 'desc' => $this->l('Fee given for each visit.')), array('type' => 'text', 'label' => $this->l('Base fee:'), 'name' => 'base_fee', 'size' => 8, 'desc' => $this->l('Fee given for each order placed.')), array('type' => 'text', 'label' => $this->l('Percent fee:'), 'name' => 'percent_fee', 'size' => 8, 'desc' => $this->l('Percent of the sales.')))));
    ...
    {
        return AdminReferrersController::displayCalendarForm(array('Calendar' => $this->l('Calendar'), 'Day' => $this->l('Today'), 'Month' => $this->l('Month'), 'Year' => $this->l('Year')), $this->token, $action, $table, $identifier, $id);
    }
