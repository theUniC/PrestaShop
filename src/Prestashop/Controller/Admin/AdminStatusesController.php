...
use Prestashop\Order\OrderReturnState;
...
*/
class AdminStatusesController extends AdminController
{
    ...
    protected function initOrdersReturnsList()
    {
        ...
        $this->fields_list = array('id_order_return_state' => array('title' => $this->l('ID'), 'align' => 'center', 'width' => 25), 'name' => array('title' => $this->l('Name'), 'align' => 'left', 'width' => 'auto', 'color' => 'color'));
    }
    protected function initOrderReturnsForm()
    {
        ...
        if ($order_return_state->id) {
            $helper->fields_value = array('name' => $this->getFieldValue($order_return_state, 'name'), 'color' => $this->getFieldValue($order_return_state, 'color'));
        } else {
