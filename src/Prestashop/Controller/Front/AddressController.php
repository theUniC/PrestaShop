...
use AddressStandardizationSolution;
...
class AddressController extends FrontController
{
    ...
    protected function assignVatNumber()
    {
        ...
        $this->context->smarty->assign(array('vatnumber_ajax_call' => file_exists(_PS_MODULE_DIR_ . 'vatnumber/ajax.php'), 'vat_display' => $vat_display));
    }
