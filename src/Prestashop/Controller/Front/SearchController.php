...
class SearchController extends FrontController
{
    ...
    public function initContent()
    {
        ...
        if ($this->instant_search && !is_array($query)) {
            ...
            $this->context->smarty->assign(array('products' => $search['result'], 'search_products' => $search['result'], 'nbProducts' => $search['total'], 'search_query' => $query, 'instant_search' => $this->instant_search, 'homeSize' => Image::getSize(ImageType::getFormatedName('home'))));
        } else {
            if (($query = Tools::getValue('search_query', Tools::getValue('ref'))) && !is_array($query)) {
                ...
                $nbProducts = $search['total'];
                $this->pagination($nbProducts);
                $this->context->smarty->assign(array('products' => $search['result'], 'search_products' => $search['result'], 'nbProducts' => $search['total'], 'search_query' => $query, 'homeSize' => Image::getSize(ImageType::getFormatedName('home'))));
            } else {
