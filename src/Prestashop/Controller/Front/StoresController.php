...
class StoresController extends FrontController
{
    ...
    protected function assignStoresSimplified()
    {
        ...
        $this->context->smarty->assign(array('simplifiedStoresDiplay' => true, 'stores' => $stores));
    }
    ...
    protected function assignStores()
    {
        ...
        $this->context->smarty->assign(array('distance_unit' => $distanceUnit, 'simplifiedStoresDiplay' => false, 'stores' => $this->getStores()));
    }
    /**
    ...
    protected function displayAjax()
    {
        ...
        foreach ($stores as $store) {
            ...
            $newnode->setAttribute('lat', (double) $store['latitude']);
            $newnode->setAttribute('lng', (double) $store['longitude']);
    ...
    public function initContent()
    {
        ...
        $this->context->smarty->assign(array('mediumSize' => Image::getSize(ImageType::getFormatedName('medium')), 'defaultLat' => (double) Configuration::get('PS_STORES_CENTER_LAT'), 'defaultLong' => (double) Configuration::get('PS_STORES_CENTER_LONG'), 'searchUrl' => $this->context->link->getPageLink('stores'), 'logo_store' => Configuration::get('PS_STORES_ICON')));
