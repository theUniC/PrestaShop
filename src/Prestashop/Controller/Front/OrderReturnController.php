...
*/
class OrderReturnController extends FrontController
{
    public $auth = true;
    ...
    {
        parent::initContent();
        $this->context->smarty->assign(array('errors' => $this->errors, 'nbdaysreturn' => (int) Configuration::get('PS_ORDER_RETURN_NB_DAYS')));
