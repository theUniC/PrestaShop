...
class HelperList extends Helper
{
    ...
    public function displayDeleteLink($token = null, $id, $name = null)
    {
        ...
        $data = array($this->identifier => $id, 'href' => Tools::safeOutput($this->currentIndex . '&' . $this->identifier . '=' . $id . '&delete' . $this->table . '&token=' . ($token != null ? $token : $this->token)), 'action' => self::$cache_lang['Delete']);
            ...
            switch ($params['type']) {
                ...
                case 'select':
                    foreach ($params['list'] as $option_value => $option_display) {
                        if (isset(Context::getContext()->cookie->{$prefix . $this->table . 'Filter_' . $params['filter_key']}) && Context::getContext()->cookie->{$prefix . $this->table . 'Filter_' . $params['filter_key']} == $option_value && Context::getContext()->cookie->{$prefix . $this->table . 'Filter_' . $params['filter_key']} != '') {
