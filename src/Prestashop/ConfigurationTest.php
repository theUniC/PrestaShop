...
class ConfigurationTest
{
    ...
    {
        return array('system' => array('fopen', 'fclose', 'fread', 'fwrite', 'rename', 'file_exists', 'unlink', 'rmdir', 'mkdir', 'getcwd', 'chdir', 'chmod'), 'phpversion' => false, 'upload' => false, 'gd' => false, 'mysql_support' => false, 'config_dir' => 'config', 'cache_dir' => 'cache', 'sitemap' => 'sitemap.xml', 'log_dir' => 'log', 'img_dir' => 'img', 'mails_dir' => 'mails', 'module_dir' => 'modules', 'theme_lang_dir' => 'themes/' . _THEME_NAME_ . '/lang/', 'theme_pdf_lang_dir' => 'themes/' . _THEME_NAME_ . '/pdf/lang/', 'theme_cache_dir' => 'themes/' . _THEME_NAME_ . '/cache/', 'translations_dir' => 'translations', 'customizable_products_dir' => 'upload', 'virtual_products_dir' => 'download');
    }
    /**
    ...
    {
        return array('fopen' => false, 'register_globals' => false, 'gz' => false, 'mcrypt' => false, 'mbstring' => false, 'magicquotes' => false, 'dom' => false, 'pdo_mysql' => false);
    }
    /**
