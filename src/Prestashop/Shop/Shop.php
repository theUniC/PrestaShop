...
class Shop extends ObjectModel
{
    ...
    protected $webserviceParameters = array('fields' => array('id_shop_group' => array('xlink_resource' => 'shop_groups'), 'id_category' => array(), 'id_theme' => array()));
        ...
        if (!$id_shop && defined('_PS_ADMIN_DIR_') || Tools::isPHPCLI()) {
            ...
            if (!Validate::isLoadedObject($shop) || !$shop->active || !$id_shop) {
                ...
                if (!Configuration::get('PS_REWRITING_SETTINGS')) {
                    ...
                    if (strpos($default_shop->domain, 'www.') === 0 && 'www.' . $_SERVER['HTTP_HOST'] === $default_shop->domain || $_SERVER['HTTP_HOST'] === 'www.' . $default_shop->domain) {
