...
class Media
{
    ...
    public static function minifyHTML($html_content)
    {
        if (strlen($html_content) > 0) {
            ...
            $html_content = preg_replace_callback('/(<[a-zA-Z0-9]+)((\\s?[a-zA-Z0-9]+=[\\"\\\'][^\\"\\\']*[\\"\\\']\\s?)*)>/', array('Media', 'minifyHTMLpregCallback'), $html_content, Media::getBackTrackLimit());
    ...
    public static function packJSinHTML($html_content)
    {
        if (strlen($html_content) > 0) {
            ...
            $html_content = preg_replace_callback('/\\s*(<script\\b[^>]*?>)([\\s\\S]*?)(<\\/script>)\\s*/i', array('Media', 'packJSinHTMLpregCallback'), $html_content, Media::getBackTrackLimit());
...
', ''), '', $css_content);
    ...
    public static function getJqueryPath($version = null, $folder = null, $minifier = true)
    {
        ...
        if ($version === null) {
            ...
            if (preg_match('/^([0-9]+\\.)+[0-9]$/Ui', $version)) {
