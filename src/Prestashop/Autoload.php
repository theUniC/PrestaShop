...
class Autoload
{
    ...
    public function load($classname)
    {
        ...
        if (!isset($this->index[$classname]) || $this->index[$classname] && !is_file($this->root_dir . $this->index[$classname]) || isset($this->index[$classname . 'Core']) && $this->index[$classname . 'Core'] && !is_file($this->root_dir . $this->index[$classname . 'Core'])) {
            $this->generateIndex();
        }
    ...
    {
        $classes = array_merge($this->getClassesFromDir('classes/'), $this->getClassesFromDir('override/classes/'), $this->getClassesFromDir('controllers/'), $this->getClassesFromDir('override/controllers/'));
        ksort($classes);
        $content = '<?php
