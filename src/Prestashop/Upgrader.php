...
class Upgrader
{
    ...
    protected function addChangedFile($path)
    {
        ...
        if (strpos($path, 'mails/') !== false) {
            ...
            if (strpos($path, '/en.php') !== false || strpos($path, '/fr.php') !== false || strpos($path, '/es.php') !== false || strpos($path, '/it.php') !== false || strpos($path, '/de.php') !== false || strpos($path, 'translations/') !== false) {
