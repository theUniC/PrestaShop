...
class Blockcontactinfos extends Module
{
    ...
    public function uninstall()
    {
        ...
        return Configuration::deleteByName('blockcontactinfos_company') && Configuration::deleteByName('blockcontactinfos_address') && Configuration::deleteByName('blockcontactinfos_phone') && Configuration::deleteByName('blockcontactinfos_email') && parent::uninstall();
    }
    ...
    public function hookFooter($params)
    {
        if (!$this->isCached('blockcontactinfos.tpl', $this->getCacheId())) {
            $this->smarty->assign(array('blockcontactinfos_company' => Configuration::get('blockcontactinfos_company'), 'blockcontactinfos_address' => Configuration::get('blockcontactinfos_address'), 'blockcontactinfos_phone' => Configuration::get('blockcontactinfos_phone'), 'blockcontactinfos_email' => Configuration::get('blockcontactinfos_email')));
        }
