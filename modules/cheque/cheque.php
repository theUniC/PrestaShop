...
', '<br />', Configuration::get('CHEQUE_ADDRESS')));
    ...
    public function hookPayment($params)
    {
        ...
        $this->smarty->assign(array('this_path' => $this->_path, 'this_path_cheque' => $this->_path, 'this_path_ssl' => Tools::getShopDomainSsl(true, true) . __PS_BASE_URI__ . 'modules/' . $this->name . '/'));
