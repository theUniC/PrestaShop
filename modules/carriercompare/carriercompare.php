...
class CarrierCompare extends Module
{
    ...
    public function postProcess()
    {
        ...
        $this->smarty->assign(array('display_error' => count($errors) ? $errors : false));
    }
    ...
    public function hookShoppingCart($params)
    {
        ...
        $this->smarty->assign(array('countries' => Country::getCountries((int) $this->context->cookie->id_lang, true), 'id_carrier' => $params['cart']->id_carrier ? $params['cart']->id_carrier : Configuration::get('PS_CARRIER_DEFAULT'), 'id_country' => $id_country, 'id_state' => $id_state, 'zipcode' => $zipcode, 'currencySign' => $this->context->currency->sign, 'currencyRate' => $this->context->currency->conversion_rate, 'currencyFormat' => $this->context->currency->format, 'currencyBlank' => $this->context->currency->blank, 'new_base_dir' => $moduleURL, 'refresh_method' => $refresh_method === false ? 0 : $refresh_method));
    ...
    private function checkZipcode($zipcode, $id_country)
    {
        ...
        $regxMask = str_replace(array('N', 'C', 'L'), array('[0-9]', $country->iso_code, '[a-zA-Z]'), $country->zip_code_format);
