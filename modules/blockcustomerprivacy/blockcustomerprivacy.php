...
class Blockcustomerprivacy extends Module
{
    ...
    public function install()
    {
        ...
        Configuration::updateValue('CUSTPRIV_MESSAGE', array($this->context->language->id => $this->l('The personal data you provide is used to answer queries, process orders or allow access to specific information.') . ' ' . $this->l('You have the right to modify and delete all the personal information found in the "My Account" page. ')));
        return $return;
    }
