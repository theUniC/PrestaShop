...
class HomeSlider extends Module
{
            ...
            foreach ($slides as $slide) {
                $this->_html .= '
					<li id="slides_' . $slide['id_slide'] . '">
						...
						<p style="float: right">' . $this->displayStatus($slide['id_slide'], $slide['active']) . '
    ...
    private function _displayAddForm()
    {
        ...
        } elseif (Tools::isSubmit('id_slide')) {
            /* Edit legend */
    ...
    private function _postValidation()
    {
        ...
        if (Tools::isSubmit('submitSlider')) {
            if (!Validate::isInt(Tools::getValue('HOMESLIDER_SPEED')) || !Validate::isInt(Tools::getValue('HOMESLIDER_PAUSE')) || !Validate::isInt(Tools::getValue('HOMESLIDER_WIDTH')) || !Validate::isInt(Tools::getValue('HOMESLIDER_HEIGHT'))) {
    ...
    private function _prepareHook()
    {
        if (!$this->isCached('homeslider.tpl', $this->getCacheId())) {
            $slider = array('width' => Configuration::get('HOMESLIDER_WIDTH'), 'height' => Configuration::get('HOMESLIDER_HEIGHT'), 'speed' => Configuration::get('HOMESLIDER_SPEED'), 'pause' => Configuration::get('HOMESLIDER_PAUSE'), 'loop' => Configuration::get('HOMESLIDER_LOOP'));
