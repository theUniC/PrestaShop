...
class LoyaltyModule extends ObjectModel
{
    ...
    public static function getVoucherValue($nbPoints, $id_currency = NULL)
    {
        ...
        return (int) $nbPoints * (double) Tools::convertPrice(Configuration::get('PS_LOYALTY_POINT_VALUE'), $currency);
    }
    public static function getNbPointsByPrice($price)
    {
        ...
        $points = 0;
        if ($pointRate = (double) Configuration::get('PS_LOYALTY_POINT_RATE')) {
