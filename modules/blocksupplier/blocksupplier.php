...
class BlockSupplier extends Module
{
    ...
    public function install()
    {
        ...
        if (!$this->registerHook('displayLeftColumn') || !$this->registerHook('displayHeader') || !$this->registerHook('actionObjectSupplierDeleteAfter') || !$this->registerHook('actionObjectSupplierAddAfter') || !$this->registerHook('actionObjectSupplierUpdateAfter')) {
            return false;
        }
