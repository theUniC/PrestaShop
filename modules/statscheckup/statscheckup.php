...
class StatsCheckUp extends Module
{
    ...
    {
        $confs = array('CHECKUP_DESCRIPTIONS_LT' => 100, 'CHECKUP_DESCRIPTIONS_GT' => 400, 'CHECKUP_IMAGES_LT' => 1, 'CHECKUP_IMAGES_GT' => 2, 'CHECKUP_SALES_LT' => 1, 'CHECKUP_SALES_GT' => 2, 'CHECKUP_STOCK_LT' => 1, 'CHECKUP_STOCK_GT' => 3);
    ...
    public function hookAdminStatsModules()
    {
        ...
        $arrayColors = array(0 => '<img src="../modules/' . $this->name . '/red.png" alt="' . $this->l('Bad') . '" />', 1 => '<img src="../modules/' . $this->name . '/orange.png" alt="' . $this->l('Average') . '" />', 2 => '<img src="../modules/' . $this->name . '/green.png" alt="' . $this->l('Good') . '" />');
        ...
        $arrayConf = array('DESCRIPTIONS' => array('name' => $this->l('Descriptions'), 'text' => $this->l('Chars (without HTML)')), 'IMAGES' => array('name' => $this->l('Images'), 'text' => $this->l('Images')), 'SALES' => array('name' => $this->l('Sales'), 'text' => $this->l('orders / month')), 'STOCK' => array('name' => $this->l('Available quantity for sale'), 'text' => $this->l('Items')));
        $this->html = '
		<style type="text/css">
