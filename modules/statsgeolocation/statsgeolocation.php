...
class StatsGeoLocation extends Module
{
    ...
    public function displayForm()
    {
        ...
        if (file_exists('../modules/' . $this->name . '/' . $this->_map_path) == FALSE || file_exists('../modules/' . $this->name . '/' . $this->_cross_path) == FALSE || !($map_size = getimagesize('../modules/' . $this->name . '/' . $this->_map_path)) || !($cross_size = getimagesize('../modules/' . $this->name . '/' . $this->_cross_path))) {
