...
abstract class awDriver
{
     ...
     * @param awImage $image
     */
    public abstract function init(awImage $image);
    /**
     ...
     */
    public abstract function initFromFile(awFileImage $fileImage, $file);
    /**
     ...
     */
    public abstract function setImageSize($width, $height);
    /**
     ...
     */
    public abstract function setPosition($x, $y);
    /**
     * Inform the driver of the position of your image
     ...
     */
    public abstract function setAbsPosition($x, $y);
    /**
     ...
     */
    public abstract function movePosition($x, $y);
    /**
     ...
     */
    public abstract function setSize($w, $h);
    /**
     * Inform the driver of the size of your image
     ...
     * @param int $h Image height
     */
    public abstract function setAbsSize($w, $h);
    /**
     ...
     * @var bool $bool
     */
    public abstract function setAntiAliasing($bool);
    /**
     ...
     */
    public abstract function getColor(awColor $color);
    /**
     * Draw an image here
     *
     ...
     */
    public abstract function copyImage(awImage $image, awPoint $p1, awPoint $p2);
    /**
     * Draw an image here
     *
     * @param awImage $image Image
     ...
     */
    public abstract function copyResizeImage(awImage $image, awPoint $d1, awPoint $d2, awPoint $s1, awPoint $s2, $resample = TRUE);
    /**
     * Draw a string
     *
     ...
     */
    public abstract function string(awText $text, awPoint $point, $width = NULL);
    /**
     * Draw a pixel
     *
     ...
     * @param awPoint $p
     */
    public abstract function point(awColor $color, awPoint $p);
    /**
     * Draw a colored line
     *
     ...
     */
    public abstract function line(awColor $color, awLine $line);
    /**
     * Draw a color arc
     ...
     */
    public abstract function arc(awColor $color, awPoint $center, $width, $height, $from, $to);
    /**
     ...
     * @param int $to End angle
     */
    public abstract function filledArc(awColor $color, awPoint $center, $width, $height, $from, $to);
    /**
     ...
     * @param int $height Ellipse height
     */
    public abstract function ellipse(awColor $color, awPoint $center, $width, $height);
    /**
     ...
     * @param int $height Ellipse height
     */
    public abstract function filledEllipse($background, awPoint $center, $width, $height);
    /**
     ...
     * @param awPoint $p2
     */
    public abstract function rectangle(awColor $color, awLine $line);
    /**
     ...
     * @param awLine $line Rectangle diagonale
     */
    public abstract function filledRectangle($background, awLine $line);
    /**
     * Draw a polygon
     *
     ...
     */
    public abstract function polygon(awColor $color, awPolygon $polygon);
    /**
     ...
     * @param Polygon A polygon
     */
    public abstract function filledPolygon($background, awPolygon $polygon);
    /**
     * Sends the image, as well as the correct HTTP headers, to the browser
     *
     * @param awImage $image The Image object to send
     */
    public abstract function send(awImage $image);
    /**
     * Get the image as binary data
     *
     * @param awImage $image
     */
    public abstract function get(awImage $image);
    /**
     * Return the width of some text
     * 
     * @param awText $text
     */
    public abstract function getTextWidth(awText $text);
    /**
     * Return the height of some text
     * 
     * @param awText $text
     */
    public abstract function getTextHeight(awText $text);
    /**
     ...
     * @return bool
     */
    protected abstract function isCompatibleWithFont(awFont $font);
}
...
abstract class awFontDriver
{
     ...
     */
    public abstract function string(awDriver $driver, awText $text, awPoint $point, $width = NULL);
    /**
     ...
     */
    public abstract function getTextWidth(awText $text, awDriver $driver);
    /**
     ...
     * @param awDriver $driver The awDriver object used to draw the graph
     */
    public abstract function getTextHeight(awText $text, awDriver $driver);
}
...
', $textString);
        foreach ($lines as $i => $line) {
            ...
            $function($driver->resource, $font->font, $driver->x + $point->x + $addX, $driver->y + $point->y + $addY + $addAngle, $line, $rgb);
        }
    }
