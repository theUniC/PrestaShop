...
abstract class awPlot extends awComponent
{
    ...
    public function getYMin()
    {
        ...
        return is_null($this->yMin) ? array_min($this->datay) : (double) $this->yMin;
    }
    /**
    ...
    public function getYMax()
    {
        ...
        return is_null($this->yMax) ? array_max($this->datay) : (double) $this->yMax;
    }
    /**
    ...
    public function getRealYMin()
    {
        ...
        if ($this->space->bottom !== NULL) {
            ...
            return is_null($this->yMin) ? $min : (double) $this->yMin;
        }
    }
    /**
    ...
    public function getRealYMax()
    {
        ...
        if ($this->space->top !== NULL) {
            ...
            return is_null($this->yMax) ? $max : (double) $this->yMax;
        }
    }
     ...
     * @return bool
     */
    public abstract function getXCenter();
