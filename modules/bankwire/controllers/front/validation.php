...
class BankwireValidationModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        $mailVars = array('{bankwire_owner}' => Configuration::get('BANK_WIRE_OWNER'), '{bankwire_details}' => nl2br(Configuration::get('BANK_WIRE_DETAILS')), '{bankwire_address}' => nl2br(Configuration::get('BANK_WIRE_ADDRESS')));
