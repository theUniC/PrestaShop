...
class StatsLive extends Module
{
    ...
    public function hookAdminStatsModules($params)
    {
        ...
        if (!Configuration::get('PS_STATSDATA_CUSTOMER_PAGESVIEWS')) {
            $this->html .= '<div class="warn">' . $this->l('You must activate the option "pages viewed for each customer" in the "Stats data-mining" module in order to see the pages viewed by your customers.') . '
			</div>';
        }
        $this->html .= '
