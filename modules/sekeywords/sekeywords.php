...
class SEKeywords extends ModuleGraph
{
    ...
    public function hookAdminStatsModules()
    {
		...
		<div class="blocStats"><h2 class="icon-guide"><span></span>' . $this->l('Guide') . '</h2>
			...
			<p>' . $this->l('One of the most common ways of finding a website through a search engine.') . $this->l('Identifying the most popular keywords entered by your new visitors allows you to see the products you should put in front if you want to achieve SEO. ') . '
			</p><br />
