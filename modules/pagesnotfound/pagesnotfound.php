    ...
    public function hookAdminStatsModules()
    {
		...
		<div class="blocStats"><h2 class="icon-guide"><span></span>' . $this->l('Guide') . '</h2>
			...
			<p>' . $this->l('If your webhost supports .htaccess files, you can create one in the root directory of PrestaShop and insert the following line inside:') . ' 
				<i>ErrorDocument 404 ' . __PS_BASE_URI__ . '404.php</i>. ' . $this->l('A user requesting a page which doesn\'t exist will be redirected to the following page.') . ' <i>' . __PS_BASE_URI__ . '404.php</i>. ' . $this->l('This module logs access to this page.') . '</p><br />
		</div>';
        return $this->_html;
    }
