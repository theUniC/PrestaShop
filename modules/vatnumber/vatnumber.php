...
use Prestashop\Tax\TaxManagerModule;
/*
...
class VatNumber extends TaxManagerModule
{
    ...
    {
        $intracom_array = array('AT' => 'AT', 'BE' => 'BE', 'DK' => 'DK', 'FI' => 'FI', 'FR' => 'FR', 'FX' => 'FR', 'DE' => 'DE', 'GR' => 'EL', 'IE' => 'IE', 'IT' => 'IT', 'LU' => 'LU', 'NL' => 'NL', 'PT' => 'PT', 'ES' => 'ES', 'SE' => 'SE', 'GB' => 'GB', 'CY' => 'CY', 'EE' => 'EE', 'HU' => 'HU', 'LV' => 'LV', 'LT' => 'LT', 'MT' => 'MT', 'PL' => 'PL', 'SK' => 'SK', 'CZ' => 'CZ', 'SI' => 'SI', 'RO' => 'RO', 'BG' => 'BG');
        ...
        for ($i = 0; $i < 3; $i++) {
            if ($pageRes = file_get_contents($url)) {
                if (preg_match('/invalid VAT number/i', $pageRes)) {
                    ...
                    if (preg_match('/valid VAT number/i', $pageRes)) {
                        @ini_restore('default_socket_timeout');
                        return array();
                    } else {
                        ++$i;
