...
class productsCategory extends Module
{
    ...
    public function hookProductFooter($params)
    {
        ...
        if (!$this->isCached('productscategory.tpl', $this->getCacheId($cache_id))) {
            ...
            // Display tpl
            $this->smarty->assign(array('categoryProducts' => $categoryProducts, 'middlePosition' => (int) $middlePosition, 'ProdDisplayPrice' => Configuration::get('PRODUCTSCATEGORY_DISPLAY_PRICE')));
        }
