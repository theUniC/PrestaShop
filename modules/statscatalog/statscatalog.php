...
class StatsCatalog extends Module
{
    ...
    public function hookAdminStatsModules($params)
    {
        ...
        $conversion = number_format((double) ($totalPageViewed ? $totalBought / $totalPageViewed : 0), 2, '.', '');
        if ($conversionReverse = number_format((double) ($totalBought ? $totalPageViewed / $totalBought : 0), 2, '.', '')) {
        ...
        $html .= '
			...
			<table>
				...
				' . $this->returnLine($this->l('Average number of page visits:'), number_format((double) $averageViewed, 2, '.', '')) . '
				' . $this->returnLine($this->l('Average number of purchases:'), number_format((double) $averagePurchase, 2, '.', '')) . '
				' . $this->returnLine($this->l('Images available:'), (int) $totalPictures) . '
				' . $this->returnLine($this->l('Average number of images:'), number_format((double) $averagePictures, 2, '.', '')) . '
